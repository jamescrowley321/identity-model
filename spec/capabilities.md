...
|------|-----------|------|-------------|--------|----|----|
| Core | OIDC Discovery | OIDC Discovery 1.0 §3–4 | `discovery.json` | implemented | planned | planned |
| Core | JWKS Retrieval + Caching | RFC 7517, RFC 7518 | `jwks.json` | implemented | planned | planned |
...
| Core | UserInfo | OIDC Core 1.0 §5.3 | `userinfo.json` | implemented | planned | planned |
