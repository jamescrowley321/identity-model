...
independently of the core `py-identity-model` library. Releases from 0.2.0 on
are generated by python-semantic-release from `(fastapi)`-scoped commits and
inserted below the marker.
